...
// ── 004 · เงินเข้าที่พักไว้ ──────────────────────────────────────────────────
//
// ก้อนโอน OTA ต้นเดือนเป็นของคำจองที่เช็คเอาท์เดือนก่อน เพราะรอบโอนของ Trip.com
// กับ Booking.com ห่างจากวันเช็คเอาท์ 7–10 วัน รายงานการรับเงินของเดือนที่เงินเข้า
// จึงไม่มีวันมีคำจองนั้นอยู่เลย
//
// เดิมก้อนแบบนี้ค้างเป็น "ไม่พบคำจอง" ตลอดไป ปนอยู่กับงานที่ทำได้จริง แล้วทำให้
// ตัวเลขงานค้างของทุกเดือนพองขึ้นเรื่อย ๆ จนไม่มีใครเชื่อมันอีก
//
// การพักไว้ไม่ใช่การปิดงาน: ยอดยังอยู่ครบ เหตุผลถูกบันทึก และปลดกลับเข้าคิวได้
// ทุกเมื่อ — ต่างจากการซ่อน ตรงที่มันยังนับอยู่และยังอธิบายตัวเองได้

const LINE_HOLDS = `CREATE TABLE IF NOT EXISTS clearclose.line_holds (
...
export const MIGRATIONS = [
  ...
  { id: "004-line-holds", sql: LINE_HOLDS },
];
